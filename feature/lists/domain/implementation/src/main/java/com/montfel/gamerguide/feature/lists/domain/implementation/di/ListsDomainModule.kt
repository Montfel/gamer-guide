...
import com.montfel.gamerguide.feature.lists.domain.implementation.usecase.GetAllFavoritedGamesUseCaseImpl
...
val listsDomainModule = module {
    ...
    singleOf(::GetAllFavoritedGamesUseCaseImpl) bind GetAllFavoritedGamesUseCase::class
}
